...
def NUWrite(filepath):
    with open(filepath, "wb") as f:
        ...
        f.write(b"NU20")
        f.write(pack("<i", -abs(16+15+1*len(bpy.data.materials)*464+16+1+14+1*len(bpy.data.objects)*448+2+16+1*len(bpy.data.objects)*80+16+16+16)))
        f.write(pack("<I", 6))
        f.write(pack("<I", 0))
        f.write(b"NTBL")
        f.write(pack("<I", 16))
        ...
        if VertexDataCount == len(obd.vertices):
            ...
            raise Exception("ERROR MUst be 4 only")
        f.write(b"INST")
