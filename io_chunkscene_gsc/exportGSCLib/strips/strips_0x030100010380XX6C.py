...
def vertices_0x03010010380XX6C_(f):
    ...
    for i, obdata in enumerate(bpy.data.meshes):
        if len(obdata.vertices) == 3:
            ...
            f.write(pack("<I", 448))
            f.write(pack("<H", len(obdata.vertices)*2-12))
            f.write(pack("<H", 24581))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
            ...
            f.write(pack("<I", 464))
            f.write(pack("<H", len(obdata.vertices)*2-14))
            f.write(pack("<H", 24581))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
            ...
            f.write(pack("<I", 480))
            f.write(pack("<H", len(obdata.vertices)*1+5))
            f.write(pack("<H", 24581))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
            f.write(pack("<I", 0))
